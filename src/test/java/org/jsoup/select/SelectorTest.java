...
public class SelectorTest {
    ...
    @Test
    public void testWildcardNamespacedXmlTag() {
        Document doc = Jsoup.parse("<div><Abc:Def id=1>Hello</Abc:Def></div> <Abc:Def class=bold id=2>There</abc:def>", "", Parser.xmlParser());
        Elements byTag = doc.select("*|Def");
        assertEquals(2, byTag.size());
        assertEquals("1", byTag.first().id());
        assertEquals("2", byTag.last().id());
    ...
    @Test
    public void testWildCardNamespacedCaseVariations() {
    ...
    @Test
    public void matchesWholeOwnText() {
    ...
    @Test
    public void nthLastChildWithNoParent() {
    ...
    @Test
    public void startsWithBeginsWithSpace() {
    ...
    @Test
    public void endsWithEndsWithSpaces() {
        Document doc = Jsoup.parse("<small><a href=\" mailto:abc@def.net \">(abc@def.net)</a></small>");
    ...
    @Test
    void containsTextQueryIsNormalized() {
    ...
    @Test
    public void selectorExceptionNotStringFormatException() {
