...
public class W3CDomTest {
    ...
    public void simpleConversion() {
        ...
        String furtherExpected = "<?xml version=\"1.0\" encoding=\"UTF-8\"?><html xmlns=\"http://www.w3.org/1999/xhtml\"><head><title>W3c</title></head><body><p class=\"one\" id=\"12\">Text</p><!-- comment --><invalid>What<script>alert('!')</script></invalid></body></html>";
    ...
    public void xmlnsXpathTest() throws XPathExpressionException {
        ...
        // namespace aware; HTML namespace is default
    ...
    public void canOutputHtmlWithoutNamespace() {
        ...
        assertEqualsIgnoreCase("<html><head><meta http-equiv=\"content-type\" content=\"text/html; charset=utf-8\"></head><body><p>one</p></body></html>", asHtml);
        assertEqualsIgnoreCase("<?xml version=\"1.0\" encoding=\"UTF-8\"?><html><head/><body><p>One</p></body></html>", asXtml);
    }
