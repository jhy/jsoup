...
public class HttpConnectionTest {
    ...
    @Test
    public void canCreateEmptyConnection() {
    ...
    @Test
    public void throwsExceptionOnResponseWithoutExecute() {
        assertThrows(IllegalArgumentException.class, () -> {
    ...
    @Test
    void encodedUrlDoesntDoubleEncode() throws MalformedURLException {
    ...
    @Test
    public void supportsInternationalDomainNames() throws MalformedURLException {
    ...
    @Test
    void supportsIdnWithPort() throws MalformedURLException {
    ...
    @Test
    public void validationErrorsOnExecute() throws IOException {
