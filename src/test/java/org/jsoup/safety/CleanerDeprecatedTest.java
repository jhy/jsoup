...
public class CleanerDeprecatedTest {
    ...
    @Test public void testCleanAnchorProtocol() {
        ...
        // A Whitelist that does not white anchors will strip them out.
        ...
        // A Whitelist that whites them will keep them.
    ...
    @Test public void handlesNestedQuotesInAttribute() {
        ...
        Whitelist white = Whitelist.relaxed()
            .addAttributes("div", "style");

        String clean = Jsoup.clean(orig, white);
        boolean isValid = Jsoup.isValid(orig, white);
