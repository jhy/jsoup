...
public class CleanerTest {
    ...
    void removeProtocols() {
        ...
        // all removed means any will work
        String clean2 = Jsoup.clean(h, safelist);
    ...
    public void handlesAllPseudoTag() {
        ...
        Safelist safelist = new Safelist().addAttributes(":all", "class").addAttributes("p", "style").addTags("p", "a");
    ...
    @Test
    public void handlesNoHrefAttribute() {
    ...
    @Test
    public void handlesNestedQuotesInAttribute() {
    ...
    @Test
    public void copiesOutputSettings() {
    ...
    @Test
    void preservesSourcePositionViaUserData() {
