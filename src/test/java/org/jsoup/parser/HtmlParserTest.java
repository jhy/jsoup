...
public class HtmlParserTest {
    ...
    public void dropsDuplicateAttributes(String html, String expected) {
        ...
        assertEquals(expected, el.outerHtml());
    ...
    @Test
    void allDashCommentsAreNotParseErrors() {
    ...
    @Test
    public void parseBodyIsIndexNoAttributes() {
    ...
    @Test
    public void testUnclosedNoscriptInHead() {
    ...
    @Test
    public void optionalPClosersAreNotErrors() {
    ...
    @Test
    public void testHtmlLowerCaseAttributesOfVoidTags() {
    ...
    @Test
    public void testHtmlLowerCaseAttributesForm() {
    ...
    public void preservedCaseLinksCantNest() {
        ...
        Document doc = Parser.htmlParser().settings(preserveCase).parseInput(html, "");
    ...
    @Test
    public void characterReaderBuffer() throws IOException {
    ...
    @Test
    public void preserveWhitespaceInHead() {
        String html = "\n<!doctype html>\n<html>\n<head>\n<title>Hello</title>\n</head>\n<body>\n<p>One</p>\n</body>\n</html>\n";
        Document doc = Jsoup.parse(html);
    ...
    @Test
    public void handleContentAfterBody() {
    ...
    @Test
    void wholeTextTreatsBRasNewline() {
    ...
    @Test
    public void canDetectAutomaticallyAddedElements() {
    ...
    @Test
    public void canSetHtmlOnCreatedTableElements() {
    ...
    @Test
    public void parseFragmentOnCreatedDocument() {
    ...
    public void nestedPFragments() {
        ...
        assertEquals("<p>\n <p></p><a></a></p>", node.parent().outerHtml());
    }

    @Test
    public void nestedAnchorAdoption() {
    ...
    @Test
    public void tagsMustStartWithAscii() {
    ...
    @Test
    void htmlOutputCorrectsInvalidAttributeNames() {
    ...
    void templateTableRowFragment() {
        ...
        // invokes the fragment parser with template as context
        tmpl.html(html);
    ...
    @Test
    void templateNotInTableRowFragment() {
        // https://github.com/jhy/jsoup/issues/1409 (per the fragment <tr> use case)
    ...
    @Test
    void trimNormalizeElementNamesInBuilder() {
    ...
    @Test
    void mergeHtmlAttributesFromBody() {
    ...
    @Test
    void mergeHtmlNoAttributesFromBody() {
    ...
    void supportsRuby() {
        ...
        assertEquals("<ruby><rbc><rb>10</rb><rb>31</rb><rb>2002</rb></rbc><rtc><rt>Month</rt><rt>Day</rt><rt>Year</rt></rtc><rtc><rt>Expiration Date</rt><rp>(*)</rp></rtc></ruby>", TextUtil.stripNewlines(ruby.outerHtml()));
        // 3 errors from rb in rtc as undefined
        assertEquals("<1:38>: Unexpected StartTag token [<rb>] when in state [InBody]", errors.get(2).toString());
    }

    @Test
    void rubyRpRtImplicitClose() {
        ...
        assertEquals(0, parser.getErrors().size());
        Element ruby = doc.expectFirst("ruby");
        assertEquals("<ruby><rp>(</rp><rt>Hello</rt><rt>Hello</rt><rp>)</rp></ruby>", TextUtil.stripNewlines(ruby.outerHtml()));
    }
    ...
    void rubyScopeError() {
        ...
        assertEquals(2, errors.size());
        Element ruby = doc.expectFirst("ruby");
        assertEquals("<ruby><div><rp>Hello</rp></div></ruby>", TextUtil.stripNewlines(ruby.outerHtml()));
        assertEquals("<1:16>: Unexpected StartTag token [<rp>] when in state [InBody]", errors.get(0).toString());
    }

    @Test
    void errorOnEofIfOpen() {
        String html = "<div>";
        Parser parser = Parser.htmlParser();
        parser.setTrackErrors(10);
        Document doc = Jsoup.parse(html, parser);
