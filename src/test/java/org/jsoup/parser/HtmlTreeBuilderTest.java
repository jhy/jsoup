...
public class HtmlTreeBuilderTest {
    ...
    public void nonnull() {
        assertThrows(IllegalArgumentException.class, () -> {
            ...
            // not sure how to test that these visual warnings actually appear! - test below checks for method annotation
    ...
    @Test
    public void nonnullAssertions() throws NoSuchMethodException {
