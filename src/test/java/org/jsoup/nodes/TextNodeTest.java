...
public class TextNodeTest {
    ...
    @Test
    void testSplitTextValidation() {
        Document doc = Jsoup.parse("<div>Hello there</div>");
        Element div = doc.expectFirst("div");
        TextNode tn = (TextNode) div.childNode(0);
        Throwable ex = assertThrows(ValidationException.class, () -> tn.splitText(-5));
        assertEquals("Split offset must be not be negative", ex.getMessage());
        ex = assertThrows(ValidationException.class, () -> tn.splitText(500));
