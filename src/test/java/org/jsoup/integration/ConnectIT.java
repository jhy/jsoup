...
public class ConnectIT {
    ...
    public void slowReadOk() throws IOException {
        ...
        Document doc = Jsoup.connect(SlowRider.Url).data(SlowRider.MaxTimeParam, // the request completes in 2 seconds
        "2000").get();
    ...
    public void remainingAfterFirstRead() throws IOException {
        ...
        try (BufferedInputStream inputStream = Jsoup.connect(url).maxBodySize(capSize).execute().bodyStream()) {
